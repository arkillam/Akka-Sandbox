...
// from: https://github.com/jasongoodwin/learning-akka/blob/master/ch2/futures-examples-java/src/test/java/pong/PongActorTest.java

public class PongActorTestFull {
